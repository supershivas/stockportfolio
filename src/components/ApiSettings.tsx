...
import { X, Key, CheckCircle, XCircle, Loader2, ExternalLink, Cloud } from 'lucide-react'
      ...
      <div className="rounded-2xl w-full max-w-md p-6" style={{ background: 'var(--card-bg)', border: '1px solid var(--card-border)' }}>
        ...
        <div className="mt-5 pt-4" style={{ borderTop: '1px solid var(--card-border)' }}>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-green-500 font-medium">Sync GitHub actif</span>
          </div>
          <p className="text-xs mt-2" style={{ color: 'var(--text-muted)' }}>
            Les positions sont sauvegardées automatiquement dans le repo GitHub à chaque modification.
            Disponible sur tous vos appareils sans code.
          </p>
        </div>
      </div>
    </div>
